## from ai-jason / ai-jayzee / ai-jz https://github.com/JayZeeDesign discord : 
...
load_dotenv()
brwoserless_api_key = os.getenv("BROWSERLESS_API_KEY") # reconsider browsing
serper_api_key = os.getenv("SERP_API_KEY") # improve tool
airtable_api_key = os.getenv("AIRTABLE_API_KEY") # swap with new dataloaders
config_list = config_list_from_json("OAI_CONFIG_LIST") #autogen stuffs need to update
